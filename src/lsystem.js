...
export default function Lsystem(axiom, grammar, iterations) {
	...
	this.DoIterations = function(n) {
		...
		//iterate through every node in linked list, call replacenode
		//add "replaceable" flag for each node
		//only call replacenode if node is replaceable

		//for each node that is replacebale, call replacenode
		//but, the grammarstring input is the return of another function/
		//implement this function which does
				//look through grammar array
		for(var r = 0; r < n; r++)
		{
