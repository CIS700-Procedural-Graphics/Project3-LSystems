...
export default class Turtle {
    ...
    constructor(scene, grammar) {
        ...
        if (typeof grammar === "undefined") {
            this.renderGrammar = {
                ...
                'A' : this.operateA.bind(this), // rotate
                'B' : this.operateB.bind(this), // distribute
    ...
    resumeState()
    {
      //var s= new TurtleState(this.state);
      // this.clear();
      // this.state = new TurtleState(new THREE.Vector3(0,0,0), new THREE.Vector3(0,1,0));
       this.state=this.stateStack.pop();
      //console.log(this.stateStack.pop());
      // this.state.pos=s.pos;
      // this.state.dir=s.dir;
    ...
    operateA()
    {
      this.rotateTurtle(Math.random()*90,Math.random()*90,Math.random()*90);
    }
    ...
    makeCylinder(len, width) {
      ...
      //  this.state.scaleY(currentNode.age);
